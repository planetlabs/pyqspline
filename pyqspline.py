...
def interpolate(n,ns,ds,maxit,tol,wi,wf,x,y):
    ...
    Args:
        ...
        ds: interval between output points (if ds>0.0, it is used over ns).
    ...
    Returns:
        ...
        omega: output list of interpolated angular rate [wx,wy,wz] (rad/sec).
        alpha: output list of interpolated angular acceleration [ax,ay,az] (rad/sec^2).
